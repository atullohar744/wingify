...
if(isset($_POST['submit'])){
	...
	echo '<pre>' . print_r($login, 1) . '<pre>'; die;
}
closedb();
?>
<!DOCTYPE html>
      ...
      <div class="login_wrapper">
        <div class="animate form login_form">
          <section class="login_content">
            <form name="loginForm" id="loginForm" action="<?php echo $PHP_SELF; ?>" method="post">
              <h1>Login Form</h1>
              <div>
              ...
              <div>
                <button class="btn btn-round btn-warning" type="submit" name="submit">Log in</button>
